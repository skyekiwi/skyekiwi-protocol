...
import { buildCall, buildCalls, buildOutcome, buildOutcomes, Call, Calls, Outcome, Outcomes, parseCall,
  parseCalls,
  parseOutcome,
...
describe('@skyekiwi/s-contract/borsh', function () {
  ...
  test('encode/decode batch outcome works', () => {
    ...
    expect(parsedOutcomes.call_index).toEqual(1);
